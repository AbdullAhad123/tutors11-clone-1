<?php
/**
 * File name: JourneySetRepository.php
...
class JourneySetRepository
{
    /**
     * JourneySet Configuration Steps
     *
     * @param null $pId
     * @param string $active
     * @return array[]
    ...
    public function getSteps($pId = null, $active = 'details')
    {
        ...
        return [
            ...
            //             'title' => __('Details'),
            //             'status' => $active == 'details' ? 'active' : 'inactive',
            //             'url' => $pId != null ? route('parent-practice-sets.edit', ['practice_set' => $pId]) : ''
            //         ],
            //         [
            //             'step' => 2,
            //             'key' => 'settings',
            //             'title' => __('Settings'),
            //             'status' => $active == 'settings' ? 'active' : 'inactive',
            //             'url' => $pId != null ? route('parent-practice-sets.settings', ['practice_set' => $pId]) : ''
            //         ],
            //         [
            //             'step' => 3,
            //             'key' => 'questions',
            //             'title' => __('Questions'),
            //             'status' => $active == 'questions' ? 'active' : 'inactive',
            //             'url' => $pId != null ? route('parent-practice-sets.questions', ['practice_set' => $pId]) : ''
            //         ],
            //     ];
            // }
