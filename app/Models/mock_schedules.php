...
class mock_schedules extends Model
{
    use HasFactory;
    use SoftDeletes;
    use SecureDeletes;
    ...
    */
    ...
    protected $table = 'mock_schedules';
    protected $guarded = [];
    ...
    */
    ...
    {
        static::creating(function ($mockSchedule) {
            $mockSchedule->attributes['code'] = 'esd_'.Str::random(11);
        });
    ...
    */
    ...
    {
        return $this->belongsToMany(UserGroup::class, 'user_group_mock_schedules', 'mock_schedule_id', 'user_group_id');
    }
