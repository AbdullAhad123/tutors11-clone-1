...
class ExamScheduleCrudController extends Controller
{
    ...
    public function index($id, ExamScheduleFilters $filters)
    {
        ...
        return view('Admin/ExamSchedules', [
    ...
    public function store(StoreExamScheduleRequest $request)
    {
        ...
        return [
            'exam' => $exam->only(['id', 'title']),
            'successMessage' => "Exam Schedule was successfully added!",
            'success' => true,
            'schedule' => $schedule,
        ];
    }
    ...
    public function destroy(Exam $exam, $id)
    {
        try {
            ...
            return [
                'message' => "Unable to Delete Exam Schedule. Remove all associations and Try again!",
                'success' => false,
                'examSchedule' => [],
            ];
        }
        return [
            'message' => "Exam Schedule was successfully deleted!",
            'success' => true,
