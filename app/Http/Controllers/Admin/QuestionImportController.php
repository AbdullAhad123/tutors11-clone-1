...
class QuestionImportController extends Controller
{
    ...
    {
        return view('Admin/ImportQuestions', [
    ...
    public function import(ImportQuestionsRequest $request, $id)
    {
        if(config('tutor11.demo_mode')) {
            return back()->with('errorMessage','Demo Mode! Files can\'t be imported.'); 
        }
        ...
        try {
            ...
            return back()->with('errorMessage','Oops! Upload Failed. Please check all rows are entered accurately.'); 
        }

        return redirect()->route('questions.index')->with('successMessage', $import->getRowCount().' Questions were imported successfully.');
    }
