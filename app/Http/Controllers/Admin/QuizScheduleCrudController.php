...
class QuizScheduleCrudController extends Controller
{
    ...
    public function index($id, QuizScheduleFilters $filters)
    {
        ...
        return view('Admin/QuizSchedules', [
    ...
    public function store(StoreQuizScheduleRequest $request)
    {
        ...
        $request->grace_period = (int)$request->grace_period;
        $request->quiz_id = (int)$request->quiz_id;
        ...
        return [
            'quiz' => $quiz->only(['id', 'title']),
            'successMessage' => "Quiz Schedule was successfully added!",
            'success' => true,
            'schedule' => $schedule,
        ];
    }
    ...
    public function destroy(Quiz $quiz, $id)
    {
        try {
            ...
            return [
                'message' => "Quiz Schedule was successfully deleted!",
                'success' => true,
            ...
            return [
                'message' => "Unable to Delete Quiz Schedule. Remove all associations and Try again!",
                'success' => false,
                'quizSchedule' => [],
            ];
        }
