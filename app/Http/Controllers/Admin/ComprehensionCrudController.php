...
class ComprehensionCrudController extends Controller
{
    ...
    {
        return view('Admin/Comprehensions', [
    ...
    public function create(ComprehensionFilters $filters)
    {
    ...
    public function store(StoreComprehensionRequest $request)
    {
        ...
        return [
            'success' => true,
            'messages' => 'Comprehension Passage was successfully added!',
        ];
    }
    ...
    public function update(UpdateComprehensionRequest $request, $id)
    {
        ...
        return [
            'success' => true,
            'messages' => 'Comprehension Passage was successfully updated!',
        ];
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            if(!$comprehension->canSecureDelete('questions')) {
                return [
                    'success' => false,
                    'message' => 'Unable to Delete Comprehension . Remove all associations and Try again!',
                ];
            }
            ...
            return [
                'success' => false,
                'message' => 'Unable to Delete Comprehension Passage . Remove all associations and Try again!',
            ];
        }
        return [
            'success' => true,
            'message' => 'Comprehension Passage was successfully deleted!',
        ];
    }
}
