...
class QuizQuestionController extends Controller
{
    ...
    public function randomlyAddQuestions($id, Request $request)
    {
        $added = [];
        $quiz = Quiz::select()->findOrFail($id);
        $sections = SubCategorySections::where('sub_category_id', $quiz->sub_category_id)->pluck('section_id');
        $skillIds = Skill::whereIn('section_id', $sections)->pluck('id');
        ...
        return redirect()->route('quizzes.schedules.index', ['quiz' => $id]);
    }
