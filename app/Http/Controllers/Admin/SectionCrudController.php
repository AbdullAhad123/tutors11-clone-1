...
class SectionCrudController extends Controller
{
    ...
    {
        $years = DB::table('sub_categories')->get();
    ...
    public function store(StoreSectionRequest $request)
    {
        ...
        DB::table('sub_category_sections')->insert(['sub_category_id' => (int)$request['year'], 'section_id' => $subject->id]);
        return [
            'success' => true,
            'message' => 'successMessage', 'Section was successfully added!'
        ];
    }
    ...
    public function edit($id)
    {
        ...
        return view('Admin/Sections/Update', [
            'section' => $section
        ]);
    }
    ...
    public function update(UpdateSectionRequest $request, $id)
    {
        ...
        return [
            'success' => true,
            'message' => 'successMessage', 'Section was successfully updated!'
        ];
    }
