...
class LessonCrudController extends Controller
{
    ...
    public function store(StoreLessonRequest $request)
    {
        ...
        $data['topic_id'] = (int)$request['topic_id'];
        Lesson::create($data);
        return [
            'success' => true,
            'messages' => 'Lesson was successfully added!',
        ];
    }
    ...
    public function update(UpdateLessonRequest $request, $id, TagRepository $tagRepository)
    {
        ...
        return [
            'success' => true,
            'messages' => 'Lesson was successfully updated!',
        ];
    ...
    public function destroy($id)
    {
        try {
            ...
            return [
                'success' => false,
                'message' => 'Unable to Delete Lesson . Remove all associations and Try again!'
            ];
        }
        return [
            'success' => true,
