...
class PaymentTransformer extends TransformerAbstract
{
    ...
    public function transform(Payment $payment)
    {
        return [
            ...
            'plan' => $payment->plan ? $payment->plan->full_name : '--',
            'user' => $payment->user ?  $payment->user->full_name : '--',
            ...
            'method' => $payment->payment_processor == 'free' ? 'Free' : config('tutor11.payment_processors')[$payment->payment_processor]['name'],
