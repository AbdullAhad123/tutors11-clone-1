...
<head>
    ...
    <meta name="description" content="Join TutorsElevenPlus for a personalised 11+ study journey. Access expert tutors, custom study plans, and top-notch resources to excel in your exams.">
    <meta name="keywords" content="registration, sign up for TutorsElevenPlus, join TutorsElevenPlus, 11+ exam registration, create account for 11+ study, enroll 11+ tutoring, {{app(\App\Settings\KeywordsSettings::class)->keywords['home_keywords']}}">
    ...
    <style>
        ...
        .login_inp:-ms-input-placeholder { /* Internet Explorer 10-11 */
            color: #ccc;
        }

        .login_inp::-ms-input-placeholder { /* Microsoft Edge */
            color: #ccc;
        }
        ...
        *{padding:0;margin:0;font-family:Kanit,sans-serif}:root{--primary:#006ae7;--secondary:#ff9d0b;--navbar-secondary:#ffaa0b;--lightersecondary:#ffe3b9;--lightblue:#97bcef;--lightprimary:#2f9aff;--greyprimary:#0074d9;--whiteprimary:#95ceff;--white:#ffffff;--light:#dbdbdbe0;--facebook:#0050ff;--instagram:#ff0081;--linkedin:#003f91;--youtube:#ff1010;--twitter:#00aeff}.text_shadow{text-shadow:1px 1px #0000003d!important}.fixed_nav{background-color:var(--primary);box-shadow:1px 3px 7px 1px #000000ad!important;margin:.25rem auto!important;border-radius:50rem!important}@media (max-width:991px){.fixed_nav{margin:0 auto!important;border-radius:0!important}}html{overflow-x:hidden}.fixed_width{max-width:1300px!important;margin-left:auto!important;margin-right:auto!important}::-webkit-scrollbar{width:8px}::-webkit-scrollbar-thumb{border-radius:10px;background-color:var(--secondary)}#offcanvasTop{background-color:var(--primary)!important}.dropdown_svg_icon{fill:#fff}a.nav-link{color:#fff!important;font-size:1rem;font-family:Kanit,sans-serif;letter-spacing:normal;word-spacing:normal;-webkit-user-select:none}a.nav-link:hover{border-radius:5px;color:var(--navbar-secondary)!important}a.nav-link:hover .dropdown_svg_icon{fill:var(--navbar-secondary)!important}.customize_dropdown:hover{font-family:Kanit,sans-serif;transition:.3s;font-size:1rem;font-family:Kanit,sans-serif;color:var(--secondary)}.offcanvas-body .customize_dropdown:hover{background-color:#bdbbbb!important}.offcanvas-body a.nav-link:hover{background-color:transparent!important}.offcanvas-body .customize_dropdown:hover{color:#0f67f5!important}a.dropdown-item:hover{background-color:hsl(0deg 0% 96.85% / 73%)!important;border-radius:5px;color:var(--primary)!important}a.dropdown-item{font-size:1rem;color:#353535}a.dropdown-item:active{color:var(--primary)!important}.btn_explore_customize{background:linear-gradient(to right,#8ed1fc,#9900ef)}a{text-decoration:none!important}.container2{position:relative;display:flex;justify-content:center;align-items:center;flex-wrap:wrap;margin:15px;padding:50px 0;gap:40px 60px}.content{position:relative;display:flex;justify-content:center;align-items:center;flex-direction:column;text-align:center;padding:40px;gap:15px}.content a::before{content:'';position:absolute;top:8px;left:50%;transform:translateX(-50%);width:65%;height:5px;border-radius:5px}.content p{color:#534c4c}.id{background-image:linear-gradient(to right,#8ed1fc,#eac6ff);background-size:contain;padding:20px}.login_content_container{min-height:100vh;max-height:auto;width:100%}@keyframes input-animate{0%{transform:scale(1)}40%{transform:scale(1.3,.7)}55%{transform:scale(1)}70%{transform:scale(1.2,.8)}80%{transform:scale(1)}90%{transform:scale(1.1,.9)}100%{transform:scale(1)}}@keyframes input-check{0%{transform:scale(0) rotate(-45deg)}100%{transform:scale(1) rotate(-45deg)}}:root{--primary:#006ae7;--secondary:#ff9d0b;--navbar-secondary:#ffaa0b;--lightersecondary:#ffe3b9;--lightblue:#97bcef;--lightprimary:#2f9aff;--greyprimary:#0074d9;--whiteprimary:#95ceff;--white:#ffffff;--light:#dbdbdbe0;--facebook:#0050ff;--instagram:#ff0081;--linkedin:#003f91;--youtube:#ff1010;--twitter:#00aeff}html{overflow-x:hidden}.fixed_width{max-width:1300px!important;margin-left:auto!important;margin-right:auto!important}::-webkit-scrollbar{width:8px}::-webkit-scrollbar-thumb{border-radius:10px;background-color:var(--secondary)}.footer_section{background:var(--primary)}footer a{text-decoration:none}.footer_list_item a{color:var(--white);transition:.3s;text-transform:capitalize}.footer_list_item a:hover{color:var(--secondary)}.footer_list_item a:hover{color:var(--secondary)}.footer_list_item{transition:.3s; text-align: left;}.footer_list_item:hover{transform:translateX(2px)}.footer_bg_facebook{height:35px;width:35px;transition:.3s}.footer_bg_facebook:hover{background:#fff!important;color:var(--facebook)}.footer_bg_instagram{height:35px;width:35px;transition:.3s}.footer_bg_instagram:hover{background:#fff!important;color:var(--instagram)}.footer_bg_linkedin{height:35px;width:35px;transition:.3s}.footer_bg_linkedin:hover{background:#fff!important;color:var(--linkedin)}.footer_bg_youtube{height:35px;width:35px;transition:.3s}.footer_bg_youtube:hover{background:#fff!important;color:var(--youtube)}.footer_bg_twitter{height:35px;width:35px}.footer_bg_twitter svg{fill:#fff}.footer_bg_twitter:hover{background:#fff!important}.footer_bg_twitter:hover.footer_bg_twitter svg{fill:#000}.footer_bg_tiktok{height:35px;width:35px}.footer_bg_tiktok:hover{border:2px solid #000!important;background:#000!important;color:var(--white);text-shadow:1px 1px 0 #ff003b}.about_section{height:auto;width:auto;margin:5rem auto}a{text-decoration:none!important}.contact_section{height:auto;width:auto;margin:4rem auto}.content{position:relative;display:flex;justify-content:center;align-items:center;flex-direction:column;text-align:center;padding:40px;gap:15px}.content a::before{content:'';position:absolute;top:8px;left:50%;transform:translateX(-50%);width:65%;height:5px;border-radius:5px}.content p{color:#534c4c}.footer-section{background:var(--primary);position:relative}.footer_icons_link{height:35px;width:35px;background:#ffffff00!important;color:#fff;border:2px solid #fff!important}.footer-content{position:relative;z-index:2}.footer-logo img{max-width:120px}.footer-text p{margin-bottom:14px;font-size:14px;color:#ffffff;line-height:21px}.facebook-bg{background:#3b5998}.twitter-bg{background:#55acee}.copyright-text p{margin:0;font-size:14px;color:#878787}.copyright-text p a{color:#ff5e14}.twitter-bg{background:#eceeee}.instagram-bg{background:linear-gradient(#ffb302,#d400ff)}.linkedin-bg{background:#0a66c2}.youtube-bg{background:#f12626}
        ...
        .login_form_image, .login_close_image {
                        ...
                        <form method="POST" action="{{ route('user_register') }}" class="card-body login_card p-lg-5 rounded-3">
                            ...
                            @endif
                                ...
                                <div class="text-center my-3">
                                    <img src="{{url('images\login_form_imagee.png')}}" class="img-fluid login_form_image user_login_avatar p-0 img-thumbnail mx-auto rounded-circle" width="200px" alt="profile">
                                    <img src="{{url('images\logn_form_closedd_eyes.png')}}" class="img-fluid login_close_image user_login_avatar p-0 img-thumbnail mx-auto rounded-circle" width="200px" alt="profile">
                                </div>
                                <div class="mb-3">
                                    <select class="form-select shadow-sm p-3 text-uppercase text-dark" id="role_select" aria-label="role_select">
                                ...
                                <div class="mb-3">
                                    <div class="form-floating bg-white">
                                        <input type="text" name="first_name" class="form-control text-dark shadow-sm login_inp" required id="loginFirstName"
                                            placeholder="Enter first name" required autocomplete="given-name" value="@if(count($errors->all()) > 0){{Request::old('first_name')}}@endif"/>
                                        <label for="loginFirstName" class="text-uppercase text-dark"><span class="position-relative">First Name <span class="position-absolute text-danger" style="bottom: 2px;">*</span></span></label>
                                    </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-floating bg-white">
                                        <input type="text" name="last_name" class="form-control text-dark shadow-sm login_inp" required id="loginLastName"
                                            placeholder="Enter last name" required autocomplete="given-name" value="@if(count($errors->all()) > 0){{Request::old('last_name')}}@endif"/>
                                            <label for="loginLastName" class="text-uppercase text-dark"><span class="position-relative">Last Name <span class="position-absolute text-danger" style="bottom: 2px;">*</span></span></label>
                                    </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-floating bg-white">
                                        <input type="text" name="user_name" class="form-control text-dark shadow-sm login_inp" required id="loginUserName"
                                            placeholder="Enter username" required autocomplete="off" value="@if(count($errors->all()) > 0){{Request::old('user_name')}}@endif"/>
                                        <label for="loginUserName" class="text-uppercase text-dark">
                                            <span class="position-relative">Username <span class="position-absolute text-danger" style="bottom: 2px;">*</span></span>
                                        </label>
                                    </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-floating bg-white">
                                        <input type="text" name="email" class="form-control text-dark shadow-sm login_inp" required id="loginEmail"
                                            placeholder="Enter email" required autocomplete="given-name" value="@if(count($errors->all()) > 0){{Request::old('email')}}@endif"/>
                                            <label for="loginEmail" class="text-uppercase text-dark"><span class="position-relative">Email <span class="position-absolute text-danger" style="bottom: 2px;">*</span></span></label>
                                    </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-floating bg-white position-relative  text-dark">
                                        <input type="password" name="password" class="form-control text-dark shadow-sm login_inp" required id="loginPass"
                                            placeholder="Enter password" value="@if(count($errors->all()) > 0){{Request::old('password')}}@endif"/>
                                        <label for="loginPass" class="text-uppercase text-dark"><span class="position-relative">Password <span class="position-absolute text-danger" style="bottom: 2px;">*</span></span></label>
                                ...
                                <div class="g-recaptcha mt-2" data-sitekey="6LeOxk8qAAAAACSzzsTTDDgfPp0rQHZAm6iLKFb2"></div>
                                ...
                                <div class="text-center visually-hidden">
                                    <button id="login_button" class="button btn btn-primary px-5 mb-2 py-2 w-100 text-uppercase fw-semibold shadow-none" type="submit">Create an Account</button>
                                </div>
                                <div class="text-center">
                                    <button id="check_credentials" class="btn btn-primary fs-5 fw-medium mb-2 p-2 shadow-none text-uppercase w-100" type="button">Create an Account</button>
                                </div>
                                <div id="emailHelp" class="form-text text-center mb-5 text-dark fs-6">Already have an account? <a href="/login" class="text-primary"> Sign in</a></div>
                            </div>
                            @if(count($errors->all()) > 0)
                            ...
                            @endif
                                ...
                                <div class="row">
                                    <div class="col-sm-6 my-3">
                                        <div class="bg-white m-auto text-center py-3 pb-0 px-2 rounded role_wrap shadow-sm" data-role="parent">
                                            <h2 class="fw-normal mb-0 text-dark fs-5">I'm a parent</h2>
                                            <img width="250" height="auto" class="mt-4" src="{{url('images\parent_account.png')}}" alt="a couple of parent standing together showing love for tutorselevenplus">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 my-3">
                                        <div class="bg-white m-auto text-center py-3 pb-0 px-2 rounded role_wrap shadow-sm" data-role="teacher">
                                            <h2 class="fw-normal mb-0 text-dark fs-5">I'm a teacher</h2>
                                            <img width="250" height="auto" class="mt-4" src="{{url('images\teacher_account.png')}}" alt="an experienced teacher is standing alone showing love for tutorselevenplus">
                                        </div>
                                    </div>
                                </div>
                            </div>
