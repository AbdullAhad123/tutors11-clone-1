...
<head>
    ...
    <style>
        *{padding:0;margin:0;font-family:Kanit,sans-serif}:root{--primary:#006ae7;--secondary:#ff9d0b;--navbar-secondary:#ffaa0b;--lightersecondary:#ffe3b9;--lightblue:#97bcef;--lightprimary:#2f9aff;--greyprimary:#0074d9;--whiteprimary:#95ceff;--white:#ffffff;--light:#dbdbdbe0;--facebook:#0050ff;--instagram:#ff0081;--linkedin:#003f91;--youtube:#ff1010;--twitter:#00aeff}.text_secondary{color:var(--secondary)!important}.text_shadow{text-shadow:1px 1px #0000003d!important}.secondary_btn{background:var(--secondary);color:#0C294C;border-radius:15px;transition:.25s;box-shadow:0 8px 11px 0 #00000057}.secondary_btn:hover{scale:1.08}.fixed_nav{background-color:var(--primary);box-shadow:1px 3px 7px 1px #000000ad!important;margin:.25rem auto!important;border-radius:50rem!important}@media (max-width:991px){.fixed_nav{margin:0 auto!important;border-radius:0!important}}html{overflow-x:hidden}.fixed_width{max-width:1300px!important;margin-left:auto!important;margin-right:auto!important}::-webkit-scrollbar{width:8px}::-webkit-scrollbar-thumb{border-radius:10px;background-color:var(--secondary)}#offcanvasTop{background-color:var(--primary)!important}.dropdown_svg_icon{fill:#fff}a.nav-link{color:#fff!important;font-size:1rem;font-family:Kanit,sans-serif;letter-spacing:normal;word-spacing:normal;-webkit-user-select:none}a.nav-link.active,a.nav-link:hover{border-radius:5px;color:var(--navbar-secondary)!important}a.nav-link:hover .dropdown_svg_icon{fill:var(--navbar-secondary)!important}a.nav-link.active{color:var(--navbar-secondary);border-radius:10px}.customize_dropdown:hover{font-family:Kanit,sans-serif;transition:.3s;font-size:1rem;font-family:Kanit,sans-serif;color:var(--secondary)}.offcanvas-body .customize_dropdown:hover{background-color:#bdbbbb!important}.offcanvas-body a.nav-link.active{background-color:transparent!important}.offcanvas-body a.nav-link.active,.offcanvas-body a.nav-link:hover{background-color:transparent!important}.offcanvas-body .customize_dropdown:hover{color:#0f67f5!important}a.dropdown-item:hover{background-color:hsl(0deg 0% 96.85% / 73%)!important;border-radius:5px;color:var(--primary)!important}a.dropdown-item{font-size:1rem;color:#353535}a.dropdown-item.active,a.dropdown-item:active{color:var(--primary)!important}.btn_explore_customize{background:linear-gradient(to right,#8ed1fc,#9900ef)}a{text-decoration:none!important}.container2{position:relative;display:flex;justify-content:center;align-items:center;flex-wrap:wrap;margin:15px;padding:50px 0;gap:40px 60px}.content{position:relative;display:flex;justify-content:center;align-items:center;flex-direction:column;text-align:center;padding:40px;gap:15px}.content a::before{content:'';position:absolute;top:8px;left:50%;transform:translateX(-50%);:65%;height:5px;border-radius:5px}.content p{color:#534c4c}.id{background-image:linear-gradient(to right,#8ed1fc,#eac6ff);background-size:contain;padding:20px}.login_inp::placeholder{color:#ccc;opacity:1}.login_inp:-ms-input-placeholder{color:#ccc}.login_inp::-ms-input-placeholder{color:#ccc}.login_content_container{min-height:100vh;max-height:auto;width:100%;background:url('{{url('images/account_login_bg.webp')}}')center no-repeat; background-size: cover;}.btn_login_primary{background-color:var(--primary);color:#fff!important;transition:.25s}.btn_login_primary:hover{background:#162e4f}.user_login_avatar{height:150px;width:150px;object-fit:cover}.login_card{background-color:#f4faff}.checkbox-animate{display:flex;justify-content:start;align-items:center;width:100%;height:auto;font-family:arial;font-size:16px}.checkbox-animate label{position:relative;cursor:pointer}.checkbox-animate label input{opacity:0;position:absolute;left:0;top:0;z-index:-1}.input-check{display:inline-block;width:20px;height:20px;border-radius:4px;border:2px solid #ccc;position:relative;top:6px;margin-right:4px;transition:.4s}.input-check::before{content:'';display:inline-block;width:10px;height:5px;border-bottom:3px solid #fff;border-left:3px solid #fff;transform:scale(0) rotate(-45deg);position:absolute;top:6px;left:4px;transition:.4s}.checkbox-animate label input:checked~.input-check{background-color:var(--primary);border-color:var(--primary);animation-name:input-animate;animation-duration:.7s}.checkbox-animate label input:checked~.input-check::before{transform:scale(1) rotate(-45deg);animation-name:input-check;animation-duration:.2s;animation-delay:.3s}@keyframes input-animate{0%{transform:scale(1)}40%{transform:scale(1.3,.7)}55%{transform:scale(1)}70%{transform:scale(1.2,.8)}80%{transform:scale(1)}90%{transform:scale(1.1,.9)}100%{transform:scale(1)}}@keyframes input-check{0%{transform:scale(0) rotate(-45deg)}100%{transform:scale(1) rotate(-45deg)}}.form-floating>label{padding:1.2rem .875rem!important}:root{--primary:#006ae7;--secondary:#ff9d0b;--navbar-secondary:#ffaa0b;--lightersecondary:#ffe3b9;--lightblue:#97bcef;--lightprimary:#2f9aff;--greyprimary:#0074d9;--whiteprimary:#95ceff;--white:#ffffff;--light:#dbdbdbe0;--facebook:#0050ff;--instagram:#ff0081;--linkedin:#003f91;--youtube:#ff1010;--twitter:#00aeff}html{overflow-x:hidden}.fixed_width{max-width:1300px!important;margin-left:auto!important;margin-right:auto!important}::-webkit-scrollbar{width:8px}::-webkit-scrollbar-thumb{border-radius:10px;background-color:var(--secondary)}.footer_section{background:var(--primary)}footer a{text-decoration:none}.footer_list_item a{color:var(--white);transition:.3s;text-transform:capitalize}.footer_list_item a:hover{color:var(--secondary)}.footer_list_item a:hover{color:var(--secondary)}.footer_list_item{transition:.3s; text-align: left}.footer_list_item:hover{transform:translateX(2px)}.footer_bg_facebook{height:35px;width:35px;transition:.3s}.footer_bg_facebook:hover{background:#fff!important;color:var(--facebook)}.footer_bg_instagram{height:35px;width:35px;transition:.3s}.footer_bg_instagram:hover{background:#fff!important;color:var(--instagram)}.footer_bg_linkedin{height:35px;width:35px;transition:.3s}.footer_bg_linkedin:hover{background:#fff!important;color:var(--linkedin)}.footer_bg_youtube{height:35px;width:35px;transition:.3s}.footer_bg_youtube:hover{background:#fff!important;color:var(--youtube)}.footer_bg_twitter{height:35px;width:35px}.footer_bg_twitter svg{fill:#fff}.footer_bg_twitter:hover{background:#fff!important}.footer_bg_twitter:hover.footer_bg_twitter svg{fill:#000}.footer_bg_tiktok{height:35px;width:35px}.footer_bg_tiktok:hover{border:2px solid #000!important;background:#000!important;color:var(--white);text-shadow:1px 1px 0 #ff003b}.about_section{height:auto;width:auto;margin:5rem auto}a{text-decoration:none!important}.contact_section{height:auto;width:auto;margin:4rem auto}.content{position:relative;display:flex;justify-content:center;align-items:center;flex-direction:column;text-align:center;padding:40px;gap:15px}.content a::before{content:'';position:absolute;top:8px;left:50%;transform:translateX(-50%);width:65%;height:5px;border-radius:5px}.content p{color:#534c4c}.footer-section{background:var(--primary);position:relative}.footer_icons_link{height:35px;width:35px;background:#ffffff00!important;color:#fff;border:2px solid #fff!important}.footer-content{position:relative;z-index:2}.footer-logo img{max-width:120px}.footer-text p{margin-bottom:14px;font-size:14px;color:#ffffff;line-height:21px}.facebook-bg{background:#3b5998}.twitter-bg{background:#55acee}.copyright-text p{margin:0;font-size:14px;color:#878787}.copyright-text p a{color:#ff5e14}.twitter-bg{background:#eceeee}.instagram-bg{background:linear-gradient(#ffb302,#d400ff)}.linkedin-bg{background:#0a66c2}.youtube-bg{background:#f12626}.login_close_image { display: none;}.login_form_card {margin: 6rem auto;} .subscribe-form { position: relative; overflow: hidden; } /* .form-floating>.form-control, .form-floating>.form-control-plaintext, .form-floating>.form-select{ line-height:1 !important; height:calc(3.1rem + calc(var(--bs-border-width) * 2)) !important } */ .subscribe-form input { width: 100%; padding: 14px 28px; color: hsl(0, 0%, 100%); } .subscribe-form button { position: absolute; right: 0; background: #ff9d0b; padding: 14px 18px; border: 1px solid #ff9d0b; top: 0; border-bottom-right-radius: 8px; border-top-right-radius: 8px; } .subscribe-form button i { color: #fff; font-size: 22px; transform: rotate(-6deg); }.login_form_image,.login_close_image {background: #2589ff !important}
        .secondary_btn{
    ...
    <title>Reset Password | Can't Log In | Tutorselevenplus Portal</title>
...
<div class="text-center my-3"><img src="{{url('images\login_form_imagee.png')}}" class="img-fluid p-0 login_form_image user_login_avatar img-thumbnail mx-auto rounded-circle" width="200" alt="profile"> <img src="{{url('images\logn_form_closedd_eyes.png')}}" class="img-fluid p-0 login_close_image user_login_avatar img-thumbnail mx-auto rounded-circle" width="200" alt="profile" loading="lazy"></div>
    <div class="mb-3">
        <label for="code" class="text-uppercase text-dark">
            Code
            <div class="text-lowercase small text-danger fw-light">The code has been sent to email address: {{$email_to}}</div>
        </label>
        <div class="position-relative text-dark rounded-1">
            <input type="text" name="code" class="p-3 form-control text-dark shadow-sm login_inp fw-light" id="code" placeholder="Enter code"> 
        </div>
        <p id="codeError" class="text-danger small error"></p>
    </div>
    <div class="mb-3">
        <label for="pass" class="text-uppercase text-dark">Password</label>
        <div class="position-relative text-dark rounded-1">
            <input type="password" name="pass" autocomplete="off" class="p-3 form-control text-dark shadow-sm login_inp fw-light" id="pass" placeholder="Enter password">
            <button type="button" class="btn btn_showPass shadow-none  border-0 position-absolute top-0 bottom-0 end-0">
                <i class="bi bi-eye-slash-fill fs-5" id="showPass_icon"></i>
            </button>
        </div>
        <p id="passError" class="text-danger small error"></p>
    </div>
    <div class="mb-3">
        <label for="conPass" class="text-uppercase text-dark">Confirm Password</label>
        <div class="position-relative text-dark rounded-1">
            <input type="password" name="conPass" autocomplete="off" class="p-3 form-control text-dark shadow-sm login_inp fw-light" id="conPass" placeholder="Enter Confirm password">
                <button type="button" class="btn btn_showConfPass shadow-none  border-0 position-absolute top-0 bottom-0 end-0">
                    <i class="bi bi-eye-slash-fill fs-5" id="showConfPass_icon"></i>
                </button>
        </div>
        <p id="conPassError" class="text-danger small error"></p>
    </div>

    <p id="code_error" class="text-danger small error"></p>
    <div class="text-center">
        <button id="login_user" class="btn btn-primary fs-5 fw-medium mb-2 p-2 shadow-none text-uppercase w-100" type="button">Reset Password</button>
    </div>

    <p id="resetError" class="text-danger small error"></p>
</div>
</div></div></div></div></div>
...
<footer class="footer_section text-center text-lg-start text-muted">
   ...
   <section class="w-100">
      <div class="fixed_width text-center mt-5">
         <div class="row m-0 mt-3">
            <div class="col-md-12 col-lg-4 col-xl-3 mx-auto mb-4">
               <div class="d-flex align-items-center justify-content-start my-3"><a class="navbar-brand" href="/"><img src="{{ url('storage/'.app(\App\Settings\SiteSettings::class)->logo_path) }}" width="45" height="45" class="img-fluid" alt="{{ url('storage/'.app(\App\Settings\SiteSettings::class)->app_name) }}"> </a><span class="m-0 ms-2 h4 text-white">{{app(\App\Settings\SiteSettings::class)->app_name}}</span></div>
    ...
    <script async src="https://cdnjs.cloudflare.com/ajax/libs/gsap/1.20.4/TweenMax.min.js"
    ...
    <script>
           $(document).ready(function () {
            ...
            $(".btn_showPass").click(function () {
              ...
              $(".btn_showConfPass").click(function () {
                let passwordValue = $("#conPass").val();

                if ($("#conPass").prop('type') === 'password') {
                    let newInput = $("<input>", {
                        class: 'p-3 form-control text-dark shadow-sm login_inp fw-light',
                        type: "text",
                        id: "conPass",
                    ...
                    $("#conPass").replaceWith(newInput);
                    $("#showConfPass_icon").removeClass("bi-eye-slash-fill").addClass("bi-eye-fill");
                    $(".login_form_image").hide();
                    $(".login_close_image").show();
                } else {
                    let newInput = $("<input>", {
                    ...
                    $("#conPass").replaceWith(newInput);
                    $("#showConfPass_icon").removeClass("bi-eye-fill").addClass("bi-eye-slash-fill");
                    $(".login_close_image").hide();
                    $(".login_form_image").show();
                }
            });
        ...
        $(".login_inp").keyup(function(){
            $(this).parent().next().text("");
        });
        $("#login_user").click(function(){
            let code = $("#code").val();
            let password = $("#pass").val();
            let confirmPassword = $("#conPass").val();
            let regcode=/^[0-9]+$/;
            if(code==""){
            ...
            {
                $('#codeError').html("Special characters and letters are not allaowed");
                $('#codeError').removeClass('d-none')
            }
            else if(code.length < 6){
            $('#codeError').html("Field must be equal to 6 digits numbers");
            $('#codeError').removeClass('d-none')
            }
            else if(code.length > 6){
            $('#codeError').html("Field must be equal to 6 digits numbers");
            ...
            $('#passError').html("Field must be equal to 9 characters");
            $('#passError').removeClass('d-none')
            }
            else{
            ...
            if(confirmPassword==""){
                $('#conPassError').html("This field is required");
                $('#conPassError').removeClass('d-none')
            }
            else if(confirmPassword != password){
            $('#conPassError').html("Password Mismatch");
            $('#conPassError').removeClass('d-none')
            }
            else{
                $('#conPassError').addClass('d-none')
              
            }
            if(code.length==6 && regcode.test(code) && password.length>=9 && confirmPassword==password){
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if(data.success){
                            ...
                            let tab=`<div class="success"> <h6 class="fs-4 fw-light text-center mb-4">`+ data.message+` </h6> <div class="text-center"><a role="button" href="/login" class="px-4 py-2 text-center border-2 secondary_btn p-2 px-3 rounded-2 rounded-pill fs-5">Login</a></div></div>`;
                            $('.login_card').empty().append(tab);
                        } else {
                            console.log("ok");
                            $('#codeError').text(data.message).removeClass('d-none');
                            $('#code').focus();
