...
<head>
    ...
    <title>Overall Report - {{$exam['title']}}</title>
    <!-- rel icon -->
...
<body> 
    ...
    <div class="d-flex justify-content-between align-items-center py-3 mb-4">
        <span>
            <h5 class="text_black font_bold m-0">Overall Report - {{$exam['title']}}</h5>
        </span>
        <span>
            <a href="/admin/exams/{{$exam['id']}}/detailed-report"><button class="btn bg-label-primary border-primary">DETAILED REPORT</button></a>
        </span>
    </div>
