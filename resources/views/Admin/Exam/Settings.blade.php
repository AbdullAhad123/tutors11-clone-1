...
<head>
    ...
    <title>Settings - {{$exam['title']}}</title>
    <!-- rel icon -->
        ...
        <div class="bg-white rounded-4 py-4 p-3 shadow">
            <div class="row m-0">
                <div class="col-12 align-self-center my-2">
                    <h1 class="h4 text-dark mb-0">Exam Settings</h1>
        ...
        <div class="bg-white rounded-4 py-4 my-4 shadow">
            <div class="container practice_set_form">
                <div class="row border-bottom my-4">
                    <div class="col-md-6 p-3 border-end">
                        ...
                        <div class="mb-4">
                            ...
                            <div>
                                <input id="passPercentage" class="inp mt-2 form-control" type="number" min="0" max="100" value="60" placeholder="Enter Percentage">
                            </div>
                        </div>
                        <div class="justify-content-between align-items-center mb-4 custom-inp-group">
                            <div>
                                ...
                                <span class="position-relative">
                                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 cursor-pointer text-primary show_tooltip"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                    <div class="bg-white position-absolute px-3 py-1 shadow start-0 rounded font-size-13 custom-tooltip d-none zindex-1">
                                        <div><span class="text-success">Yes</span> - Test taker must obtain minimum percentage in section</div>
                                        <div><span class="text-danger">No</span> - No minimum percentage required in section</div>
                                    </div>
                                </span>
                            </div>
                            <div>
                                <input id="enableSectionCutoff" class="inp" value="false" type="hidden">
                                <span class="my-1 btn border rounded-0 radio_selector yes_selector">Yes</span>
                                <span class="my-1 btn border rounded-0 radio_selector no_selector active">No</span>
                            </div>
                        </div>
                        ...
                        <div class="justify-content-between align-items-center mb-4 custom-inp-group">
                            <div>
                                ...
                                <span class="position-relative">
                                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 cursor-pointer text-primary show_tooltip"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                    <div class="bg-white position-absolute px-3 py-1 shadow start-0 rounded font-size-13 custom-tooltip d-none zindex-1">
                                        <div><span class="text-success">Yes</span> - Section navigation will be disabled during exam</div>
                                        <div><span class="text-danger">No</span> - Test takers can navigate sections during exam</div>
                                    </div>
                                </span>
                            </div>
                            <div>
                                <input id="disableSectionNavigation" class="inp" value="false" type="hidden">
                                <span class="my-1 btn border rounded-0 radio_selector yes_selector">Yes</span>
                                <span class="my-1 btn border rounded-0 radio_selector no_selector active">No</span>
                            </div>
                        </div>
                ...
                <div class="text-end my-3">
                    <button id="proceedexam" class="btn btn-primary">Save & Proceed</button>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#proceedexam").click(function(){
                ...
                let disableSectionNavigation = $("#disableSectionNavigation").val();
                let enableSectionCutoff = $("#enableSectionCutoff").val();
                $.ajax({
                    type: "POST",
                    url: '/admin/exams/'+exam_id+'/settings',
                    data: {
                        enable_section_cutoff: enableSectionCutoff,
                        disable_section_navigation: disableSectionNavigation,
                    ...
                    success: function(data) {
                        console.log("success");
                        if(data.exam){
                            window.location.href = "/admin/exams/"+data.exam+"/sections";
                        }
                    },
