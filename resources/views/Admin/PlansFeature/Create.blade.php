...
<body>
    ...
    <section class="p-4">
        ...
        <h1 class="text-dark h2 my-2">New Plan Feature</h1>

        <div class="bg-white p-4 shadow my-4 rounded-4">

            <div class="mb-3">
                <label class="fw-medium text-dark" for="name" class="form-label">Feature Name</label>
                <input type="text" class="form-control my-2 shadow-sm" id="name" placeholder="Enter Name">
            </div>
                        
            <div class="mb-3">
                <label class="fw-medium text-dark" for="description" class="form-label">Short Description (Max. 200 Characters)</label>
                <textarea class="form-control my-2 shadow-sm" name="description" id="description" rows="4" placeholder="Enter Short Description (Max. 200 Characters)"></textarea>
            </div>
