...
<body>
    ...
    <section class="p-4">
        ...
        <div class="my-4">
            <h1 class="text-dark my-2">Plan Features</h1>
            <p class="text-dark my-2 fs-5">Admins and instructors can effortlessly add, manage, and update plan features for student learning plans with a single click. For more information, please review our documentation on <a href="" class="text-primary text-decoration-none">plan features</a>.</p>
        </div>
        ...
        <div class="bg-white rounded-4 shadow my-4">
            <div class="align-items-center d-flex justify-content-between mb-4 p-3 px-4">
                <h2 class="h4 text-dark m-0">Manage Features</h2>
                <a href="/admin/plan-features/create"><button class="btn rounded-2 text-uppercase create_new_btn text-white"><i class='bx bx-plus-circle mb-1 text-white'></i>Create new</button></a>
            </div>
            <div class="table-responsive">
                <table class="table">
                    <thead class="bg-body-secondary">
                        <th scope="col" class="font_bold text-dark py-3 fs-6 w_180">CODE</th>
                        <th scope="col" class="font_bold text-dark py-3 fs-6 w_200">NAME</th>
                        <th scope="col" class="font_bold text-dark py-3 fs-6 w_300">description</th>
                                ...
                                <tr>
                                    <td data-label="code">
                                        <span class="align-items-center bg-primary cursor-pointer d-inline-flex px-2 questionCode rounded-3 small table_bg_primary text-white">
                                            ...
                                            <span class="questionCodeText">{{$feature['code']}}</span>
                                        </span>
                                    </td>
                                    <td data-label="exam">{{$feature['name']}}</td>
                                    <td data-label="completed">{{$feature['description']}}</td>
                                    <td data-label="status">
                                        @if($feature['is_active'])
                                            <span class="py-1 px-2 rounded small bg-label-primary">Active</span>
                                        @else
                                            <span class="py-1 px-2 rounded small bg-label-danger">In-Active</span>
                                        @endif
                                    </td>
                                    <td data-label="actions">
                                        <div class="border d-inline-flex dropdown rounded shadow-sm">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end p-0">
                                                <li>
                                                    <a class="dropdown-item" href="/admin/plan-features/{{$feature['id']}}/edit">Edit</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item delete cursor-pointer" data-id="{{$feature['id']}}">Delete</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
    ...
    <script>
        ...
        $(".delete").click(function() {
            ...
            $.ajax({
                type: "POST",
                url: '/admin/plan-features/delete/'+id,
                data: {
                    _token: '{{ csrf_token() }}'
                },
