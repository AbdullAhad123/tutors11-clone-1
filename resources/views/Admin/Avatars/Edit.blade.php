...
<head>
    ...
    <title>Update Avatar - {{$avatar->title}}</title>
    <!-- rel icon -->
...
<body>
    ...
    <section class="p-4">
        ...
        <h1 class="text-dark h4 my-3">Update Avatar - {{$avatar->title}}</h1>

        <div class="bg-white my-4 p-4 rounded-4 shadow">
            <form class="row py-3" action="{{ route('update_avatar', ['id' => $avatar->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf   
                <div class="form-group mb-4 col-lg-6 col-md-6 col-sm-6 col-12">
                    <label class="fw-medium text-dark" for="title">Title</label>
                    <input type="text" name="title" value="{{$avatar->title}}" id="title" placeholder="Enter Avatar Title" class="mt-2 form-control shadow-sm" required>
                </div>
                <div class="form-group mb-4 col-lg-6 col-md-6 col-sm-6 col-12">
                    <label class="fw-medium text-dark" for="points">Points to redeem</label>
                    <input type="number" name="points" id="points" value="{{$avatar->points}}" placeholder="Enter Points To Redeem" class="mt-2 form-control shadow-sm" required min="1" oninput="validity.valid||(value='');">
                </div>
                <div class="form-group mb-4 col-lg-6 col-md-6 col-sm-6 col-12 mb-4">
                    ...
                    <input type="file" name="avatar" id="avatar" class="mt-2 form-control shadow-sm" accept="image/jpeg, image/jpg, image/png, image/webp">
                ...
                <div class="form-group mb-4 col-lg-6 col-md-6 col-sm-6 col-12">
                    ...
                    <input type="number" name="sort" id="sort" value="{{$avatar->sort}}" placeholder="Enter Ordering Number" class="mt-2 form-control shadow-sm" required min="1" oninput="validity.valid||(value='');">
                </div>
                ...
                <div class="form-group mb-4 col-12">
                    ...
                    <textarea class="form-control mt-2" name="description" id="description" rows="4">{{$avatar->description}}</textarea>
                </div>    
                <!-- submit btn  -->
                <div class="text-end">
