...
<head>
    ...
    <title>Configure Lessons - {{$subCategory['name']}} {{$skill['name']}}</title>
    <!-- rel icon -->
...
<body> 
        ...
        <div class="bg-white rounded-4 py-4 my-4 p-3 shadow">
            <div class="row m-0">
                <div class="col-lg-5 col-md-12 align-self-center">
                    <div class="h5 text-dark mb-0">Configure Lessons</div>
                ...
                <div class="row">
                    <div class="col-md-4 col-12 border-end my-3">
                        ...
                        <div class="my-3">
                            Sub-topic
                            <div class="dropdown">
                                <input id="Topic" type="text" class="form-control dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="true" placeholder="Sub-topic">
                    ...
                    <div class="col-md-8 col-12 my-3">
                        <div class="alert alert_success rounded-4 shadow text-dark">
                            <div class="font-black fs-5">Currently Viewing Lessons</div>
                            <div class="nav mt-2" role="tablist">
                                <button class="bg-transparent border-0 text-primary active" id="view-lessons-tab" data-bs-toggle="tab" data-bs-target="#view-Lessons" type="button" role="tab" aria-controls="view-Lessons" aria-selected="true">View Lessons</button>
                                <span class="mx-2 align-self-center font-black"> | </span>
                                <button class="bg-transparent border-0 text-primary" id="add-lessons-tab" data-bs-toggle="tab" data-bs-target="#add-Lessons" type="button" role="tab" aria-controls="add-Lessons" aria-selected="false">Add Lessons</button>
                            </div>
                        </div>

                        <div class="bg-body-tertiary border p-3 rounded-4 shadow-sm tab-content">
                            <div class="tab-pane fade active show" id="view-Lessons" role="tabpanel" aria-labelledby="view-lessons-tab">
                                <div>
                                    <div class="text-body text-center fs-5"><span id="countLessons"></span> items found for the selected criteria.</div>
                            ...
                            <div class="tab-pane fade" id="add-Lessons" role="tabpanel" aria-labelledby="add-lessons-tab">
                                <div>
                                    <div class="text-body"><span id="countAvailableLessons"></span> items found for the selected criteria.</div>
    ...
    <script>
        $(document).ready(function () {
            ...
            fetchLessons();
            $("#add-lessons-tab").click(function(){
                addLessons();
            });
            $("#view-lessons-tab").click(function(){
                fetchLessons();
            });
            function fetchLessons() {
                $.ajax({
                    type: "GET",
                    url: '/admin/practice/'+subCategory+'/'+skill+'/fetch-practice-lessons',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
                    success: function(data) {
                        let countLessons = data['lessons'].meta.pagination.total;
                        let lessons = data['lessons'].data;
                        $("#countLessons").text(countLessons);
                        if(countLessons > 0) {
                            $("#noLessons").hide();
                            addLessonsToView($("#fetchLessons"), lessons, data['lessons'].meta.pagination);
                        } else {
                            $("#countlessons").text('0');
                        }
                    },
            ...
            function addLessons() {
                $.ajax({
                    type: "GET",
                    url: '/admin/practice/'+subCategory+'/'+skill+'/fetch-available-lessons',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
                    success: function(data) {
                        ...
                        if(countLessons > 0) {
                            ...
                            addLessonsToView($("#AvailableLessons"), lessons, data['lessons'].meta.pagination);
                        }
                    },
                    error: function(data, textStatus, errorThrown) {
                        console.log(textStatus);
            ...
            function addLessonsToView(_this, questions, pagination) {
                ...
                questions.forEach(function (question, i) {
                    ...
                    let tab =   `<div class="bg-white rounded my-3 py-3 px-2 Lesson">
                                    ...
                                    <div class="mb-2">`+question.excerpt+`</div>
                                    <div class="mb-1"><span class="fw-semibold text-secondary me-2">Read Time: </span>`+question.duration+` Minutes</div>
            ...
            $(document).on("click","#loadMore", function(e){
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        let questions = data['lessons'].data;
                        let pagination = data['lessons'].meta.pagination;
            ...
            $(document).on("click",".addavailableLesson", function(e){
                ...
                $.ajax({
                    type: "POST",
                    url: '/admin/practice/'+subCategory+'/'+skill+'/add-lesson',
                    data: {
                        lesson_id: lessonId,
                        _token: '{{ csrf_token() }}'
                    },
            ...
            $(document).on("click",".removeLesson", function(e){
                ...
                $.ajax({
                    type: "POST",
                    url: '/admin/practice/'+subCategory+'/'+skill+'/remove-lesson',
                    data: {
                        lesson_id: lessonId,
                        _token: '{{ csrf_token() }}'
                    },
