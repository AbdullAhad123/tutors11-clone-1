...
<body> 
    ...
    <section class="p-4">
        ...
        <div class="bg-white my-4 py-4 p-3 shadow rounded-4">
            <div class="row m-0">
                <div class="col-lg-5 col-md-12 align-self-center">
                    ...
                    <div class="mt-1">Add Lessons to Learning</div>
                </div>
                <div class="col-lg-7 col-md-12 d-flex justify-content-evenly">
                    @foreach ($steps as $key => $step)
                        ...
                        @else
                            <button class="btn btn-outline-primary mx-1 proceedLessons" data-type="next">
                                <span class="badge bg-primary circle-badge rounded-circle text-white"> {{$key + 1}} </span> 
                                {{$step['title']}}
                            </button>
                        @endif
        ...
        <div class="bg-white py-4 my-4 p-3 shadow rounded-4">
            <div class="container practice_set_form">

                <div class="form-group my-4 dropdown">
                    <label for="sub_category_Inp" class="fw-medium text-dark">Year</label>
                    <input id="sub_category_Inp" type="text" class="form-control dropdown-toggle mt-1" data-id="" data-trigger="0" data-bs-toggle="dropdown" aria-expanded="true" placeholder="Type to Select..." autocomplete="off">
                ...
                <div class="form-group my-4 dropdown">
                    ...
                    <input id="skill_Inp" type="text" class="form-control dropdown-toggle mt-1" data-id="" data-trigger="0" data-bs-toggle="dropdown" aria-expanded="true" placeholder="Type to Select..." autocomplete="off">
                ...
                <div class="text-end my-4">
                    <button class="btn btn-primary proceedLessons" data-type="submit">Save & Proceed</button>
                </div>
    ...
    <script>
        ...
        $(document).on("click",".proceedLessons", function(e){
            ...
            if(sub_category){
                if(skill){
                    window.location.href = "/admin/practice/"+sub_category+"/"+skill+"/lessons"
                } else {
                    if(type == 'submit'){
                        $("#formError").text("Please select subcategory from dropdown");
                    } else {
                        $("#errorMessage").append('<div class="alert_success p-3 d-flex align-items-center rounded-3 my-1"> <i class="bx bx-check-circle me-1"></i>'+data.message+'</div>');
                    }
                }
            } else {
                if(type == 'submit'){
                    $("#formError").text("Please select subcategory from dropdown");
                        ...
                        $("#errorMessage").append('<div class="alert_failed p-3 d-flex align-items-center rounded-3 my-1"> <i class="bx bx-error-circle me-1"></i>'+data.message+'</div>');
                }
            }
        });
    </script>
