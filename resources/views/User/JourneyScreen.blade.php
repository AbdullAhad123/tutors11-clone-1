    ...
    <body>
        ...
        <div class="bg-white shadow fixed-top container-fluid pb-2">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="text-center">
                    <h4 class="my-2">{{$journeySet['title']}}</h4>
                ...
                <div class="d-md-flex d-none">
                    ...
                    <a class="btn shadow-sm mx-1 btn-sm bg_label_warning" href="{{route('get_journey_session_analysis', ['journeySet' => $journeySet['slug'], 'session' => $session['code']])}}" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Pause Session"><i class="fa-regular fa-circle-pause"></i>&nbsp;Pause</a>
                ...
                <div class="dropdown d-md-none d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown_shadow border-0" aria-labelledby="menu_sm">
                        ...
                        <a class="dropdown-item small py-2" href="{{route('get_journey_session_analysis', ['journeySet' => $journeySet['slug'], 'session' => $session['code']])}}">
        ...
        <script>
            ...
            $(document).on('click', '#finish, .finish', function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('finish_journey_session', ['journeySet' => $journeySet['slug'], 'session' => $session['code']])}}",
                    data: {
                        replace: true,
                        _token: '{{ csrf_token() }}'
                    },
                    success: function(data) {
                        if(data){
                            window.location.href = "{{route('get_journey_session_analysis', ['journeySet' => $journeySet['slug'], 'session' => $session['code']])}}";
                        }
                    },
            ...
            function submitMSA(answer){
                $.ajax({
                    type: "POST",
                    url: "{{route('check_journey_answer', ['journeySet' => $journeySet['slug'], 'session' => $session['code']])}}",
                    data: {
