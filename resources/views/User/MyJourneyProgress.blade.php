  ...
  <section>
    <div class="row progress_header p-3  rounded-5 align-items-center justify-content-center">
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 d-flex justify-content-center">
          <img src="images/progress_report.png" width="300" height="300" class="img-fluid"alt="">
        </div>
    </div>
  </section>
    <!-- progress cards -->
          ...
          <div class="container my-3">
            <div class="row">
              <div class="col-lg-2 col-md-3 col-sm-6 col-6">
                ...
                <p class="text-dark fw-normal fs-5">Needs practice</p>
