...
<head>
    ...
    <title>{{$quiz['title']}} Results - Student Portal - Tutors 11 Plus</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap my-4">
        <h1 class="text-dark my-2 h2">Quiz Results</h1>
        <a href="/quizzes" class="align-items-center d-inline-flex my-2 text-decoration-underline text-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#006ae7" class="me-1"><path d="M21 11H6.414l5.293-5.293-1.414-1.414L2.586 12l7.707 7.707 1.414-1.414L6.414 13H21z"></path></svg> Back to Quiz</a>
    </div>
        ...
        <div class="tab-pane fade show active" id="nav-analysis" role="tabpanel" aria-labelledby="nav-analysis-tab">
            <div class="row m-0">
                <div class="col-12 col-sm-6 col-lg-3 px-3 position-relative mt-2">
                    <div class="row rounded-3 py-3 px-2 h-100 shadow-sm">
