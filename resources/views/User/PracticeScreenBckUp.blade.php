...
<html lang="en">
    <head>
        ...
        <title>{{$practiceSet['title']}} Practice - Student Portal - Tutors 11 Plus</title>
    ...
    <body>
        ...
        <div class="shadow bg-white overflow-auto p-0 position-relative rounded-3">
            <div class="bg-white py-2 px-md-4 px-2 test_navbar w-100 fixed-top z-index-1 shadow">
                <div class="d-flex m-auto align-items-center justify-content-between">
                    ...
                    <div class="text-center">
                        <h1 class="h4 fw-semibold mb-2 session_title">{{$practiceSet['title']}}</h1>
                    ...
                    <div class="d-md-flex d-none align-items-center justify-content-evenly">
                        ...
                        <a class="btn shadow-sm mx-1 btn-sm bg_label_warning" type="button" href="/journey/{{$practiceSet['slug']}}/analysis/{{$session['code']}}" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Pause Session"><i class="fa-regular fa-circle-pause"></i>&nbsp;Pause</a>
                    ...
                    <div class="dropdown d-md-none d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown_shadow border-0" aria-labelledby="menu_sm">
                            ...
                            <a class="dropdown-item small py-2" href="/journey/{{$practiceSet['slug']}}/analysis/{{$session['code']}}">
            ...
            <div class="my-2 px-3 m-auto main_test_container">
            ...
            <div class="bg-white py-3 px-4 shadow-lg w-100 fixed-bottom z-index-5">
                <div id="move_question" class="d-flex m-auto justify-content-between container">
                    <button id="prev" class="btn btn-primary d-flex align-items-center">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="20" class="me-1"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
                        Previous
                    </button>
                    <button id="next" class="btn btn-primary d-flex align-items-center">
                        Next
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="20" class="ms-1"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                    </button>
                </div>
            </div>
        </div>
        ...
        <script>
                        ...
                        if(data){
                            ...
                            questions.forEach(function(question, i){
                                ...
                                if(question.comprehension){
                                    modal_btn = `<div><button class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#comprehension_`+question.code+`"><i class="fa fa-eye"></i> Comprehension</button></div>`;
                                ...
                                wrong_ques_modal =  `<div class="modal fade" id="wrong_ques`+question.id+`" aria-labelledby="m odalToggleLabel" tabindex="-1" style="display: none;" aria-hidden="true">
                                ...
                                let tab =   `<div class="bg-white tab-pane fade video_tab rounded-5" data-type="`+question.questionType+`" data-status="`+question.status+`" data-ques="`+question.id+`" data-id="`+question.code+`" id="video-`+page+i+`" role="tabpanel" aria-labelledby="video-tab-`+page+i+`" data-index="`+index+`">
                                                <div class="animate__animated animate__fadeIn">
                                                    <div class="mb-2 font-size-13 d-flex justify-content-between align-items-center"> <div class='h6'><span class="fw-semibold">Q`+index+` of `+data.total+`</span> <span class="fw-normal text-uppercase">| `+question.skill+`</span></div> `+modal_btn+` </div>
            ...
            function answeredMSA(question) {
                ...
                correctAnswer = `<div class="alert alert-success border border-2 border-success my-3 rounded-4 text-dark"><i class="fa fa-bolt-lightning me-2 text-success"></i>Correct answer is Option `+question.ca+`</div>`;
                });
            ...
            function submitMSA(answer) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $(".video_tab.active").find(".answer_wrap").append('<div class="alert alert-success border border-2 border-success my-3 rounded-4 text-dark"><i class="fa fa-bolt-lightning me-2 text-success"></i>Correct answer is Option '+data.ca+'</div>');
                    },
                    error: function(data, textStatus, errorThrown) {
                    },
                });
            ...
            function answeredMMA(question) {
                ...
                let tab =  `<div class="answer_wrap">`+input+`<div class="alert alert-success border border-2 border-success my-3 rounded-4 text-dark"><i class="fa fa-bolt-lightning me-2 text-success"></i>Correct answers are option `+question.ca.join(", ")+`</div></div>`;
                return tab;
            }
            ...
            function submitMMA(answer) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        let tab = `<div class="alert alert-success border border-2 border-success my-3 rounded-4 text-dark"><i class="fa fa-bolt-lightning me-2 text-success"></i>Correct answers are option `+data.ca.join(", ")+`</div>`;
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        answer.forEach(function(match, i) {
                            ...
                            if(answer[i].id == data.ca[i]){
                                matches +=  `<div class="input-group my-2 p-3 py-2 rounded-4 bg-success border border-2 border-success">
                                            <span class="bg-opacity-10 border-0 fw-semibold input-group-text align-self-center p-0 px-2 rounded-circle small">`+index+` - `+match.code+`</span>
                                            <div class="bg-transparent border-0 form-control ms-1 shadow-none text-white" data-id="`+index+`" data-match_id=`+match.id+`>`+match.value+`</div>
                                        </div>`;
                            } else {
                                matches +=  `<div class="input-group my-2 p-3 py-2 rounded-4 bg-danger border border-2 border-danger">
            ...
            function answeredSAQ(question) {
                ...
                if(question.ca.length > 1) {
                    correctAnswers = '<div class="alert alert-success border border-2 border-success my-3 rounded-4 text-dark"><i class="fa fa-bolt-lightning me-2 text-success"></i>Acceptable answers are: '+question.ca.join(", ")+' </div>'
                } else {
                    correctAnswers = '<div class="alert alert-success border border-2 border-success my-3 rounded-4 text-dark"><i class="fa fa-bolt-lightning me-2 text-success"></i>Acceptable answer is: '+question.ca.join(", ")+' </div>'
                }
                    ...
                    success: function(data) {
                        if(data){
                            ...
                            if(data.ca.length > 1) {
                                ...
                                correctAnswers = '<div class="alert alert-success border border-2 border-success my-3 rounded-4 text-dark"><i class="fa fa-bolt-lightning me-2 text-success"></i>Acceptable answer is: '+data.ca.join(", ")+' </div>'
                            }
            ...
            function checkFinish(currentPage, totalPages, totalQuestions, totalAnswered, currentQuestion) {
                if(currentPage == totalPages && totalQuestions == totalAnswered && totalQuestions ==  currentQuestion){
                    if($(".finish").length < 2){
                        $("#move_question").append('<button id="finish" class="btn text-white btn-primary text-capitalize fw-light px-4 finish">Finish</button>');
                        $("#next").addClass('d-none');
                    }
