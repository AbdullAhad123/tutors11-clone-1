...
<head>
    ...
    <title>Live Exams - Student Portal - Tutors 11 Plus</title>
...
<body>
    ...
    <div class="align-items-center d-flex justify-content-between mb-2">
        <div class="d-inline-flex position-relative">
            <h4 class="fw-semibold mb-4 mt-3 text-dark">
                Live Exams
                <span class="border border-1 border-warning d-inline-flex position-absolute rounded-circle top-0"
            ...
            success: function (data) {
                ...
                schedules.forEach(function (schedule) {
                    let tab = `<div class="col-lg-6 col-md-8 col-sm-9x col-12">
                                    <div class="bg-white h-auto my-3 py-4 px-3 rounded shadow">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-12 my-2 text-end">
                                                <div class="btn text-end">
                                                    <a href="/exam/`+ schedule.slug + `/instructions" class="Start_exam_button rounded px-3 py-2">Start Exam</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
