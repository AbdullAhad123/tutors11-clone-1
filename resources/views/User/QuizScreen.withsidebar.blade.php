...
<body class="overflow-hidden">
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-page bg-light p-4">
            <!-- navbar  -->
            <nav class="exam_navbar rounded-top-4 cutomized_container_fluid w-100 px-3 bg-white border-bottom shadow-sm">
                <div style="max-width: 1300px;" class="d-flex justify-content-between align-items-center h-100 mx-auto">
                    ...
                    <div class="exam_details_side align-items-center">
                        <div class="d-flex">
                            <span class="countdown_timer mx-1 bg-warning-subtle py-2 px-4 fs-4 rounded-3" class="tooltip_custom" data-bs-toggle="tooltip"
                                data-bs-placement="bottom" data-bs-title="Timer">
                                <i class="bx bx-time me-2 fs-4 ">
                                </i><span id="count_downTimer" data-name="">00:00</span>
                            </span>
                            <span class="fullscreen_option btn alert-danger ms-3 me-1" style="cursor: pointer;" id="fullscreen_btn"
                        ...
                        <div class="row align-items-center">
                            <div class="col-6">
                                <button class="btn btn-success shadow">
                                    <span class="me-1">
                                        <svg style="height: 18px; width: 18px;" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                ...
                                <!-- <div class=" bg-success px-3 p-2 d-inline-flex text-white "
                                    class="tooltip_custom" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                    data-bs-title="Current Section">
