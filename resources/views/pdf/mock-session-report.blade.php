...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ $mock['title'] }} Mock Test Score Report</title>
        <style>
        ...
        <table>
            ...
            <tr>
                <td colspan="2" class="w-50">
                    <span class="heading-item"><strong>Mock Test Name:</strong></span>
                    <span class="list-item">{{ $mock['title'] }}</span>
