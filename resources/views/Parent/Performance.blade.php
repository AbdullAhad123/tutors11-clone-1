 ...
 <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet"
  ...
  <body> 
            ...
            <div class="swiper-wrapper">
              @foreach($sections as $section)
                <div class="swiper-slide rounded-5">
                  <a href="{{route('parent_performance', ['id' => $section['id']])}}" class="section_card w-100 p-2 bg-white shadow-sm rounded-5 text-center
    ...
    <section class="compare_performance my-5">
      ...
      <p class="fs_cs_5">Compare and assess {{$year}} progress with peers to elevate performance above the average.</p>
    ...
    <section class="my-3">
      ...
      <div class="swiper topics_swiper my-4 p-2 mt-0">
        <div class="swiper-wrapper position-relative" data-swiper-autoplay="1000">
        ...
        <div class="heading_separator  "></div>    
         <div class="topic_heading bg-white shadow rounded-5 mt-3 p-3 ">
                  ...
                  <div class="my-4 text-center">
                    <a href="{{route('parent_practice_sets_create')}}" class="btn fw-normal  px-3 set_practice_button p-3">Set practise on the area to improve</a>
                  </div>
                </div>
              </div>
            </div>
    ...
    <script>
      ...
      $("#setPractice").click(function(){
        ...
        if(sub_topics_to_be_practice.length > 0){
          ...
          window.location.href = "/parent/practice-sets?subject="+subject+"&topic="+topic+"&sub_topics="+sub_topics_to_be_practice.join(',');
        } else {
          window.location.href = "/parent/practice-sets";
        }
      });
