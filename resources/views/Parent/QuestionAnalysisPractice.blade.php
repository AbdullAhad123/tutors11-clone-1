...
<head>
    ...
    <title>Practises - Question Analysis | {{ app(\App\Settings\SiteSettings::class)->app_name }}</title>
    <!-- rel Question Analysis  -->
...
<body>
    ...
    <nav class='mb-4'
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item fw-light active small text-primary" aria-current="page">Question Analysis - Exams</li>
        </ol>
    </nav>

    <!-- curriculum  -->
    <section class="question_section my-4 mt-5">
        <h1 class="display-6 text-capitalize my-3 mb-2">Practise Question Analysis</h1>
        <p class="fs-5 my-3">Explore your child's performance with detailed question analysis, revealing answered, unanswered, and overall progress in practise sessions.</p>
        ...
        <nav>
            <div class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
                <a href="{{ url('question-analysis/exams') }}">
                    <button class="nav-link w-auto tab_navigation_buttons" id="nav-exam-tab" data-bs-toggle="tab" data-bs-target="#nav-exam" type="button" role="tab" aria-controls="nav-exam" aria-selected="true">
                ...
                <a href="{{ url('question-analysis/practices') }}">
                    <button class="nav-link w-auto tab_navigation_buttons active" id="nav-practice-tab" data-bs-toggle="tab" data-bs-target="#nav-practice" type="button" role="tab" aria-controls="nav-practice" aria-selected="false">
