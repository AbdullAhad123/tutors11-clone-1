...
<head>
    ...
    <title>Exams - Question Analysis | {{ app(\App\Settings\SiteSettings::class)->app_name }}</title>
    <!-- rel icon -->
...
<body>
    ...
    <section class="question_section my-4 mt-5">
        <h1 class="display-6 text-capitalize my-3 fw-semibold mb-2">Exams Question Analysis</h1>
        <p class="fs-5 my-3">Explore your child's performance with detailed question analysis, revealing answered, unanswered, and overall progress in exams.</p>
        <div class="row m-0 my-4 align-items-center justify-content-center">
            <div class="col-lg-4 col-md-6 col-sm-10 col-12 mx-auto my-2">
                <a href="{{url('question-analysis/exams')}}" class="text-decoration-none">
                    <div
                        class="align-items-center questions_analysis_card d-flex p-lg-4 p-md-4 p-3 rounded-3 selected_questions_analysis_card shadow">
