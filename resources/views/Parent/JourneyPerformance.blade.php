            ...
            <div class="swiper-wrapper">
              @foreach($sections as $section)
                <div class="swiper-slide rounded-5">
                  <a href="/parent/detailed-journey-performance?subject={{$section['id']}}" class="section_card w-100 p-2 bg-white shadow-sm rounded-5 text-center
              ...
              <div class="row align-items-center my-3">
                <div class="col-lg-3 col-md-5 col-sm-6 col-12 my-2">
                  <div class="performance_card_item p-4 shadow rounded-4 average_performance">
                    <p class="text-white fw-normal fs_cs_5">Need Practice</p>
