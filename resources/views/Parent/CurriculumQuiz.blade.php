...
<body>
    ...
    <nav class='mb-4'
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item fw-light active small text-primary" aria-current="page">Curriculum - Quizzes</li>
        </ol>
    </nav>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 my-2">
                <div class="p-4 rounded-4 session_card overflow-hidden shadow position-relative total_card">
                    <div class="d-flex align-items-center">
                        ...
                        <h2 class="h3 m-0 ms-2 text-white">Total Quiz Sessions</h2>
                    </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 my-2">
                <div class="p-4 rounded-4 session_card overflow-hidden shadow position-relative attempted_card">
                    <div class="d-flex align-items-center">
                        ...
                        <h2 class="h3 m-0 ms-2 text-white">Atempted Quiz Sessions</h2>
                    </div>
