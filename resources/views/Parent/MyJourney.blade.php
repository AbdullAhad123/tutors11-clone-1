...
<head>
    ...
    <title>Past Journey - Parent Portal - Tutors 11 Plus</title>
                ...
                <table class="table border-white">
                    <thead class="table_head_section">
                        <tr class="border-bottom">
                            ...
                            <th scope="col" class="py-3" style="min-width: 150px;color:white !important;">ATTEMPT</th>
                        ...
                        @foreach ($journeySessions['data'] as $journey)
                          @if(count($journey) > 0)
                            <tr>
                                ...
                                <td class="text-dark py-3 fw-semibold" data-label="exam">{{ $journey['name'] }}</td>
                                <td class="text-dark py-3 fw-semibold" data-label="subtitle">{{ $journey['subtitle'] }}</td>
                                <td class="text-dark py-3" data-label="completed">{{ $journey['completed'] }}</td>
                                <td class="text-dark py-3" data-label="status">
                                    <div class="d-flex align-items-center">
                                        <img src="{{url('images\reward.png')}}" width="25" height="25" alt="reward coin">
                                        <span class="ms-1">{{ $journey['total_points_earned'] }}</span>
                                    </div>  
                                </td>
                                <td class="text-dark py-3" data-label="actions"><a 
                                    href="/journey/{{$journey['slug']}}/analysis/{{$journey['id']}}" data-bs-toggle="tooltip" data-bs-html="true" data-bs-title="View Analytics">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#per_page_option').on('change', function(e) {
                ...
                var current_page = {!! isset($journeySessions['meta']['pagination']['current_page']) ? str_replace("'", "\'", json_encode($journeySessions['meta']['pagination']['current_page'])) : 1 !!};
                if (perPage == 10) {
