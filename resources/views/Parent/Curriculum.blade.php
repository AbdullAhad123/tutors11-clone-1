...
<head>
    ...
    <style>
        ...
        .curriculum_session_card {
            height: auto;
            width: auto;
            background: linear-gradient(160deg, #000000a3, #00000012), url('../images/practice_sets_section.jpg') center;
...
<body>
    ...
    <nav class='mb-4'
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item fw-light active small text-primary" aria-current="page">Curriculum - Exams</li>
        </ol>
    </nav>
        ...
        <div class="row m-0 my-3 justify-content-center">
            <div class="col-lg-4 col-md-6 col-sm-10 col-12 mx-auto my-2">
                <a href="{{url('curriculum/exams')}}" class="text-decoration-none">
                    <div
                        class="h-100 align-items-center curriculum_session_card d-flex p-lg-4 p-md-4 p-3 rounded-3 selected_curriculum_session_card shadow">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 my-2">
                <div class="p-4 rounded-4 session_card overflow-hidden shadow position-relative total_card">
                    <div class="d-flex align-items-center">
                        ...
                        <h2 class="h3 m-0 ms-2 text-white">Total Exam Sessions</h2>
                    </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 my-2">
                <div class="p-4 rounded-4 session_card overflow-hidden shadow position-relative attempted_card">
                    <div class="d-flex align-items-center">
                        ...
                        <h2 class="h3 m-0 ms-2 text-white">Atempted Exam Sessions</h2>
                    </div>
